var i18n = {
  en : {
    connectionError : 'There a problem with the WiFi connection. Please check WiFi settings or the router itself.',
    tooManyConnectionsError : 'You have reached the maximum number of simultaneous connections. We invite you to leave and come back on this page in order to watch the Live channels.',
